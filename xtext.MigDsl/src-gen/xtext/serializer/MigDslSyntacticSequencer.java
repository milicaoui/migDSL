...
public class MigDslSyntacticSequencer extends AbstractSyntacticSequencer {

	protected MigDslGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (MigDslGrammarAccess) access;
	}
